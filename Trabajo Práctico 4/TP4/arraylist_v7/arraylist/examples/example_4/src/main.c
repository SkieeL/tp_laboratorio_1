...
int main(void)
{
    ...
    #ifdef TEST
        startTesting(1);    // newArrayList     [READY]
        startTesting(2);    // add              [READY]
        startTesting(3);    // deleteArrayList  [READY]
        startTesting(4);    // len              [READY]
        startTesting(5);    // get              [READY]
        startTesting(6);    // contains         [READY]
        startTesting(7);    // set              [READY]
        startTesting(8);    // remove           [READY]
        startTesting(9);    // clear            [READY]
        startTesting(10);   // clone            [READY]
        startTesting(11);   // push             [READY]
        startTesting(12);   // indexOf          [READY]
        startTesting(13);   // isEmpty          [READY]
        startTesting(14);   // pop              [READY]
        startTesting(15);   // subList          [READY]
        startTesting(16);   // containsAll      [READY]
        startTesting(17);   // sort             [REVISAR]
    #else
        //run();
        run2();
    #endif
